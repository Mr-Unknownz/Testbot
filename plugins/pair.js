...
cmd({
    ...
    try {
        ...
        const res = await axios.get(`https://queen-jusmy-pair.onrender.com/pair?number=${encodeURIComponent(phoneNumber)}`);
        ...
        const instructions = 
            `✅ *< | 𝐐ᴜᴇᴇɴ 𝐉ᴜꜱᴍʏ 𝐌ᴅ Ｐᴀɪʀɪɴɢ Ｃᴏᴍᴘʟᴇᴛᴇᴅ.*\n\n` +
            ...
            `⚠️ *ＮＯＴＥ:* 𝚃𝙷𝙸𝚂 𝙲𝙾𝙳𝙴 𝚆𝙸𝙻𝙻 𝙴𝚇𝙿𝙸𝚁𝙴 𝙸𝙽 ❷ 𝙼𝙸𝙽𝚄𝚃𝙴𝚂. 𝚄𝚂𝙴 𝙸𝚃 𝙸𝙼𝙼𝙴𝙳𝙸𝙰𝚃𝙻𝚈..!`;
...
// send pairing code after buttons
